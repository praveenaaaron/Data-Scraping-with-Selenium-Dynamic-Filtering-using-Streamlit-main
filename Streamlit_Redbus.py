...
# kerala bus
lists_k=[]
df_k=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_k.csv")
for i,r in df_k.iterrows():
    lists_k.append(r["Route_name"])

#Andhra bus
lists_A=[]
df_A=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_A.csv")
for i,r in df_A.iterrows():
    lists_A.append(r["Route_name"])

#Telungana bus
lists_T=[]
df_T=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_T.csv")
for i,r in df_T.iterrows():
    lists_T.append(r["Route_name"])

#Goa bus
lists_g=[]
df_G=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_G.csv")
for i,r in df_G.iterrows():
    lists_g.append(r["Route_name"])

#Rajastan bus
lists_R=[]
df_R=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_R.csv")
...
# South bengal bus 
lists_SB=[]
df_SB=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_SB.csv")
for i,r in df_SB.iterrows():
    lists_SB.append(r["Route_name"])

# Haryana bus
lists_H=[]
df_H=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_H.csv")
for i,r in df_H.iterrows():
    lists_H.append(r["Route_name"])

#Assam bus
lists_AS=[]
df_AS=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_AS.csv")
for i,r in df_AS.iterrows():
    lists_AS.append(r["Route_name"])

#UP bus
lists_UP=[]
df_UP=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_UP.csv")
for i,r in df_UP.iterrows():
    lists_UP.append(r["Route_name"])

#West bengal bus
lists_WB=[]
df_WB=pd.read_csv("F:/praveena/DataScience/Mini_Project/DS_REDBUS/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/csv_files/df_WB.csv")
